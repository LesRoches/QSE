...
1. 阅读论文目录下的理论或综合学习笔记，理解模型结构。
2. 阅读论文目录下的数据与数值算法笔记，把论文公式与作者程序连接起来。
3. 若论文目录提供 Python 复现，再运行示例与测试。
...
- 模型变量、均衡条件和识别/校准方法；
- 原始代码与复现代码的映射；
- 若编写复现程序，提供可直接运行的最小示例；
- 若编写复现程序，提供对关键均衡条件的自动测试。
